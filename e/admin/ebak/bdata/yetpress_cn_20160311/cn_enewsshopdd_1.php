...
E_D("DROP TABLE IF EXISTS `cn_enewsshopdd`;");
E_C("CREATE TABLE `cn_enewsshopdd` (
...
E_D("replace into `cn_enewsshopdd` values('1','142789256097305','2015-04-01 20:50:14','2','200890234','0','0','0','的发生的','','','tt@tt.tt','45345','','讽德诵功','','3','普通邮递','5.00','24.00','3','网银支付','0','0.00','0','','0.00','','115.204.103.167','','','0.00','1427892614','1');");
