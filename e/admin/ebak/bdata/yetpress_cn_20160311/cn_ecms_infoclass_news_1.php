...
E_D("DROP TABLE IF EXISTS `cn_ecms_infoclass_news`;");
E_C("CREATE TABLE `cn_ecms_infoclass_news` (
  ...
  `zz_video_file` text NOT NULL,
  `z_video_file` varchar(255) NOT NULL,
  `qz_video_file` varchar(255) NOT NULL,
  `save_video_file` varchar(10) NOT NULL,
  `zz_playcode` text NOT NULL,
  `z_playcode` varchar(255) NOT NULL,
  `qz_playcode` varchar(255) NOT NULL,
  `save_playcode` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
