...
E_D("DROP TABLE IF EXISTS `cn_enewsspacestyle`;");
E_C("CREATE TABLE `cn_enewsspacestyle` (
...
E_D("replace into `cn_enewsspacestyle` values('1','默认个人空间模板','','默认个人空间模板','default','1',',1,2,');");
E_D("replace into `cn_enewsspacestyle` values('2','默认企业空间模板','','默认企业空间模板','comdefault','0',',3,4,');");
