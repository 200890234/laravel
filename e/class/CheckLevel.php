...
function ShowViewInfoMsg($r,$msg){
  ...
  <tr class="header"> 
    <td height="25" style="padding-left:8px;color:#eee;">提示信息</td>
  </tr>
  <tr bgcolor="#eee"> 
    <td height="25" style="padding-left:8px;"><?=$msg?></td>
  </tr>
</table>
<br>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  <!-- <tr class="header"> 
    <td height="25" colspan="2" style="padding-left:8px;color:#eee;">标题：<?=$r[title]?> </td>
  </tr> -->
  <tr bgcolor="#eee"> 
    <td height="25" style="padding-left:8px;">标题：</td>
    <td height="25">
      <?=$r[title]?>
    </td>
  </tr>
  <tr bgcolor="#eee"> 
    <td height="25" style="padding-left:8px;">查看权限：</td>
    <td height="25">
      <?=$ViewLevel?>
    </td>
  </tr>
  <tr bgcolor="#eee"> 
    <td width="17%" height="25" style="padding-left:8px;">发布时间：</td>
    <td width="83%" height="25"> 
      <?=date("Y-m-d H:i:s",$r[newstime])?>
    </td>
  </tr>
  <tr bgcolor="#eee"> 
    <td height="25" style="padding-left:8px;">信息简介：</td>
    <td height="25"> 
