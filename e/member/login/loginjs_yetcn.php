...
document.write("<div id='logedinfo'><a href=\"/e/member/cp/\" target=\"_blank\" style='background:#1ABC9C;padding:1px 12px;border-radius:5px;color:#ddd;font-size:14px;'>控制面板</a><br></div><div style='clear:both;height:8px;'></div>");
document.write("<div id=''><a href=\"/user_service/\" target=\"_blank\" style='background:#1ABC9C;padding:1px 12px;border-radius:5px;color:#ddd;font-size:14px;'>会员专区</a><br></div><div style='clear:both;height:8px;'></div>");
<?
}
else
{
...
document.write("<div class='user_form'><a href='javascript:void(0)' class='user_login'>登录</a>&nbsp;<a href='javascript:void(0)' class='user_reg'>注册</a></div>");
<?
}
?>