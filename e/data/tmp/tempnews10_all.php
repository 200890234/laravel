                ...
                <div class="list_main">
                    ...
                    <div class="list_middle">
                        ...
                        <div class="intro_text">
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select intro from [!db.pre!]enewsclass where classid='.$navinfor['classid'].' limit 1',10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                        ...
                        <div class="article_content">
                            <div class="content_title"><h4><?=$ecms_gr[title]?></h4></div>
                            <div class="article_info">
                                发布时间：<?=date('Y-m-d',$ecms_gr[newstime])?> &nbsp;&nbsp;
                                发布者：<?=$ecms_gr[username]?> &nbsp;&nbsp;
                                <!-- 字体大小：12px 14px&nbsp; -->
                                <a href="http://cn.yetpress.com/e/tool/feedback/?bid=2&info_id=<?=$ecms_gr[id]?>&info_url=<?=$grtitleurl?>">[ 信息报错 ]</a>
                                <a href="">[ 意见建议 ]</a>
                                <a href="http://cn.yetpress.com/e/tool/feedback/?bid=3&info_id=<?=$ecms_gr[id]?>&info_url=<?=$grtitleurl?>">[ 请求删帖 ]</a>
                            ...
                            <?php if($navinfor["video_file"]&&end(explode('.', $navinfor["video_file"]))!="webm"){ ?>
                            <!--极酷播放器/代码开始-->
                            <script type="text/javascript" src="http://cn.yetpress.com/player/images/swfobject.js"></script>
                            ...
                            <script type="text/javascript">
                                ...
                                var vHeight = h;　//播放器高度
                                var vPic="";
                                var vFile = "http://cn.yetpress.com/player/CuSunV2set.php";　//播放器配置文件地址
                                var vPlayer = "http://cn.yetpress.com/player/player.swf";　//视频文件地址
                                var vMp4url = "<?=$ecms_gr[video_file]?>"; 　//视频文件地址
                                //-->
                            </script>
                            <script class="CuPlayerVideo" data-mce-role="CuPlayerVideo" type="text/javascript" src="http://cn.yetpress.com/player/images/AsComV3.js"></script> 
                            <SCRIPT language=javascript src="http://cn.yetpress.com/player/images/action.js" type=text/javascript></SCRIPT>
                            <!--极酷播放器/代码结束-->
                            <?php } ?>
                            ...
                            <div class="article_pager">[!--page.url--]</div>
...
$bqno++;
?>
                                    <p>上篇：<a href="<?=$bqsr['titleurl']?>" title="<?=$bqr['title']?>"><?=$bqr['title']?></a></p>
                                <?php
}
}
?>
...
$bqno++;
?>
                                    <p>下篇：<a href="<?=$bqsr['titleurl']?>" title="<?=$bqr['title']?>"><?=$bqr['title']?></a></p>
                                <?php
}
}
?>
