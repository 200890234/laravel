...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>文件大小</td><td bgcolor='ffffff'><input name="filesize" type="text" id="filesize" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[filesize]))?>" size="60">
<select name="select" onchange="document.add.filesize.value+=this.value">
      ...
      </select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>图片尺寸</td><td bgcolor='ffffff'><input name="picsize" type="text" id="picsize" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picsize]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>图片分辨率</td><td bgcolor='ffffff'><input name="picfbl" type="text" id="picfbl" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picfbl]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>来源</td><td bgcolor='ffffff'><input name="picfrom" type="text" id="picfrom" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picfrom]))?>" size="60">
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>每行显示条数</td><td bgcolor='ffffff'><input name="num" type="text" id="num" value="<?=$ecmsfirstpost==1?"3":ehtmlspecialchars(stripSlashes($r[num]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>缩图宽度</td><td bgcolor='ffffff'><input name="width" type="text" id="width" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[width]))?>" size="6">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>缩图高度</td><td bgcolor='ffffff'><input name="height" type="text" id="height" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[height]))?>" size="6">
