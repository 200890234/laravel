...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>软件预览图</td><td bgcolor='ffffff'>
...
<select name="select" onchange="document.add.filesize.value+=this.value">
      ...
      </select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>下载地址</td><td bgcolor='ffffff'>
<script>
function doadd()
{var i;
var str="";
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>软件简介</td><td bgcolor='ffffff'><textarea name="softsay" cols="80" rows="10" id="softsay"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[softsay]))?></textarea>
</td></tr></table>