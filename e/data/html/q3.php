...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>文件大小</td><td bgcolor='ffffff'><input name="filesize" type="text" id="filesize" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'filesize',stripSlashes($r[filesize]))?>" size="42">
