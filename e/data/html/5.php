...
?><table width='100%' align=center cellpadding=3 cellspacing=1 bgcolor='#DBEAF5'><tr><td width='16%' height=25 bgcolor='ffffff'>影片名</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>影片缩略图</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>影片类型</td><td bgcolor='ffffff'><select name="movietype" id="movietype"><option value="港台影视"<?=$r[movietype]=="港台影视"?' selected':''?>>港台影视</option><option value="海外影视"<?=$r[movietype]=="海外影视"?' selected':''?>>海外影视</option><option value="大陆影视"<?=$r[movietype]=="大陆影视"?' selected':''?>>大陆影视</option><option value="日韩影视"<?=$r[movietype]=="日韩影视"?' selected':''?>>日韩影视</option></select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>出品公司</td><td bgcolor='ffffff'>
<input name="company" type="text" id="company" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[company]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>出品时间</td><td bgcolor='ffffff'>
<input name="movietime" type="text" id="movietime" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[movietime]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>主演</td><td bgcolor='ffffff'>
<input name="player" type="text" id="player" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[player]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>导演</td><td bgcolor='ffffff'>
<input name="playadmin" type="text" id="playadmin" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[playadmin]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>影片格式</td><td bgcolor='ffffff'><input name="filetype" type="text" id="filetype" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[filetype]))?>" size="8">
<select name="select2" onchange="document.add.filetype.value=this.value">
      ...
      </select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>影片大小</td><td bgcolor='ffffff'><input name="filesize" type="text" id="filesize" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[filesize]))?>" size="12">
<select name="select" onchange="document.add.filesize.value+=this.value">
      ...
      </select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>推荐等级</td><td bgcolor='ffffff'><select name="star" id="star"><option value="1"<?=$r[star]=="1"?' selected':''?>>1星</option><option value="2"<?=$r[star]=="2"||$ecmsfirstpost==1?' selected':''?>>2星</option><option value="3"<?=$r[star]=="3"?' selected':''?>>3星</option><option value="4"<?=$r[star]=="4"?' selected':''?>>4星</option><option value="5"<?=$r[star]=="5"?' selected':''?>>5星</option></select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>带宽要求</td><td bgcolor='ffffff'>
<input name="playdk" type="text" id="playdk" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[playdk]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>片长</td><td bgcolor='ffffff'>
<input name="playtime" type="text" id="playtime" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[playtime]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>扣除点数</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>播放器</td><td bgcolor='ffffff'>
<?php
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>在线观看地址</td><td bgcolor='ffffff'>
<script>
function dooadd()
{var i;
var str="";
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>影片简介</td><td bgcolor='ffffff'><textarea name="moviesay" cols="80" rows="10" id="moviesay"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[moviesay]))?></textarea>
</td></tr></table>