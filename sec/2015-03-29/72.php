...
<html lang="en">
<head>
    <title>yetpress - 软文信息相关 - 网站建设 资源分享 网络赚钱 英语学习 创意恶搞 绝密资料</title>
    <meta charset="UTF-8">
                ...
                <div class="list_main">
                    ...
                    <div class="list_middle">
                        ...
                        <div class="article_content">
                            <div class="content_title"><h4>软文信息相关</h4></div>
                            <div class="article_info">
                                发布时间：2015-03-29 &nbsp;&nbsp;
                                发布者：mervyn &nbsp;&nbsp;
                                <!-- 字体大小：12px 14px&nbsp; -->
                                <a href="http://cn.yetpress.com/e/tool/feedback/?bid=2&info_id=72&info_url=http://cn.yetpress.com/sec/2015-03-29/72.php">[ 信息报错 ]</a>
                                <a href="">[ 意见建议 ]</a>
                                <a href="http://cn.yetpress.com/e/tool/feedback/?bid=3&info_id=72&info_url=http://cn.yetpress.com/sec/2015-03-29/72.php">[ 请求删帖 ]</a>
                            ...
                            <div class="content_body">
                                <p>&nbsp;http://www.07550755.com/info/listnews14419.htm</p>                            </div>
                            <div class="article_pager"></div>
                            <div class="article_prenext">
                                                                    <p>上篇：<a href="http://cn.yetpress.com/sec/2015-03-29/71.php" title="产品信息相关">产品信息相关</a></p>
...
<div class="article_comment">
    <form action="http://cn.yetpress.com/e/pl/doaction.php" method="post" name="saypl" id="saypl" onsubmit="return CheckPl(document.saypl)">
        <div class="comment_title"><span>发表评论</span>
            <a href=javascript:void(0) class="comment_count" target="_blank">​共有<span>​<script type="text/javascript" src="http://cn.yetpress.com/e/public/ViewClick/?classid=34&id=72&down=2"></script></span>​条评论</a>​
        </div>
        <script>
        $(function(){
            var url="http://cn.yetpress.com/e/pl/?classid=34&id=72";
        ...
        <div class="comment_area">
            ...
            <div class="comment_userinfo">
                <ul>
                    ...
                    <li>
                        <input name="id" type="hidden" id="id" value="72" />
                        <input name="classid" type="hidden" id="classid" value="34" />
                        <input name="enews" type="hidden" id="enews" value="AddPl" />
                        <input name="repid" type="hidden" id="repid" value="0" />
                        <input type="hidden" name="ecmsfrom" value="http://cn.yetpress.com/sec/2015-03-29/72.php"><!-- 提交后返回地址 9为提交页面地址 -->
