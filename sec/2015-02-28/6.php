...
<html lang="en">
<head>
    <title>yetpress - 帝国cms：yetpress_cn系统文件修改记录 - 网站建设 资源分享 网络赚钱 英语学习 创意恶搞 绝密资料</title>
    <meta charset="UTF-8">
                    ...
                    <div class="list_middle">
                        ...
                        <div class="article_content">
                            ...
                            <div class="article_info">
                                ...
                                发布者：mervyn &nbsp;&nbsp;
                                <!-- 字体大小：12px 14px&nbsp; -->
                                <a href="http://cn.yetpress.com/e/tool/feedback/?bid=2&info_id=6&info_url=http://cn.yetpress.com/sec/2015-02-28/6.php">[ 信息报错 ]</a>
                                <a href="">[ 意见建议 ]</a>
                                <a href="http://cn.yetpress.com/e/tool/feedback/?bid=3&info_id=6&info_url=http://cn.yetpress.com/sec/2015-02-28/6.php">[ 请求删帖 ]</a>
                            ...
                            <div class="content_body">
                                <p><span style="font-size: 14px;">&nbsp;信息返回后台查看，点击标题才能查看到详细信息。如果辩题不是必填项并且未填，那么无处可点。这时候超链接需要给她个默认值；</span></p>
<p><span style="font-size: 14px;">打开e/admin/tool/feedback.php. 找到：</span></p>
<p><span style="font-size: 14px;">$r['title']=stripSlashes($r['title']);</span></p>
<p><span style="font-size: 14px;">在后面添加以下代码：</span></p>
<table border="0" width="100%" cellspacing="1" cellpadding="10" bgcolor="#0099CC">
    <tbody>
        <tr class="firstRow">
            ...
            <p style="line-height: normal;"><span style="font-size: 14px;">&nbsp; if(!$r['title']){</span></p>
            <p style="line-height: normal;"><span style="font-size: 14px;">&nbsp; &nbsp; $r['title']=&quot;无标题&quot;;</span></p>
...
<p><span style="font-size: 14px;">&nbsp;登陆注册弹出层提交失败后附一个返回地址，用于触发弹出层；</span></p>
<p><span style="font-size: 14px;">一、登录</span></p>
<p><span style="font-size: 14px;">打开e/member/class/member_loginfun.php</span></p>
<p><span style="font-size: 14px;">$password=trim($add['password']);后一行添加&nbsp;$tempurl=trim($add['tempurl']); tempurl是表单模板里写的自定义变量。</span></p>
<p><span style="font-size: 14px;">printerror()函数中history.go(-1)改为$tempurl</span></p>
<p><span style="font-size: 14px;">&nbsp;二、注册</span></p>
<p><span style="font-size: 14px;">打开e/member/class/member_registerfun.php</span></p>
<p><span style="font-size: 14px;">$email=RepPostStr($add['email']);后一行添加$tempurl=RepPostStr($add['tempurl']); tempurl是表单模板里写的自定义变量。</span></p>
<p><span style="font-size: 14px;">printerror()函数中history.go(-1)改为$tempurl</span></p>
<p><span style="font-size: 14px;">&nbsp;----------------------------------------------------------------</span></p>
<p><span style="font-size: 14px;">增加自定义的的js登录状态调用模板。</span></p>
<p><span style="font-size: 14px;">一、复制一份e/member/login/loginjs.php改名为loginjs_yetcn.php.</span></p>
<p><span style="font-size: 14px;">二、修改相关模板代码。</span></p>
<p><span style="font-size: 14px;">d调用地址：</span></p>
<p><span style="font-size: 14px;">---------------------------------------------------------------------------------</span></p>
<p><span style="font-size: 14px;">/e/wap/文件有修改 升级时注意备份</span></p>
<p><span style="font-size: 14px;">-------------------------2016-0301--------------------------------</span></p>
<p><span style="font-size: 14px;">&nbsp;修改/e/data/ecmseditor/infoeditor/editor/css/fck_editorarea.css文件，后台默认编辑器字体大小从12px改成了14px;（好像无效），</span></p>
<p><span style="font-size: 14px;">相关的文件是/e/data/ecmseditor/infoeditor/editor/fckeditor.html和\e\data\ecmseditor\infoeditor\fckconfig.js</span></p>
<p><span style="font-size: 14px;">&nbsp;</span></p>
<p><span style="font-size: 14px;">---------------------------------------------------------------------------------</span></p>
<p><span style="font-size: 14px;">&nbsp;整合其他编辑器。</span></p>
<p><span style="font-size: 14px;">上传相关编辑器文件到e/data/ecmseditor 下，该目录默认的内容有inforeditor和images这两个文件夹，其余为此次上传内容.</span></p>
<p><span style="font-size: 14px;">到管理数据表 - 管理字段 修改newstext字段的html替换代码为&ldquo;使用文档.php&rdquo;里面的代码；</span></p>
<p><span style="font-size: 14px;">&nbsp;-----------------------------------------------------------------</span></p>
<p><span style="font-size: 14px;"><span style="font-family: 宋体; line-height: 21px;">/e/class/CheckLevel.php 文章查看权限不足提示信息模板文件<br />
------------------------------------------------------------</span></span></p>
<p><span style="font-size: 14px;"><span style="font-family: 宋体; line-height: 21px;">增加了mibew和welive在线聊天系统，对应根目录下的两个目录和数据库中的两个数据库</span></span></p>
<p><span style="font-size: 14px;"><span style="font-family: 宋体;"><span style="line-height: 21px;">后台登陆地址：</span></span></span><span style="font-family:宋体"><span style="font-size: 14px; line-height: 21px;"><a href="http://cn.yetpress.com/mibew/" _src="http://cn.yetpress.com/mibew/"><span style="font-size: 14px;">http://cn.yetpress.com/mibew/</span></a></span></span></p>
<p><span style="font-size: 14px;">
<p><span style="font-family: 宋体;"><span style="line-height: 21px;">&nbsp;</span></span></p>
</span></p>
<p><span style="font-family:宋体"><span style="font-size: 14px; line-height: 21px;"><a href="http://www.xxxx.com/welive/admin/" _src="http://www.xxxx.com/welive/admin/"><span style="font-size: 14px;">http://www.xxxx.com/welive/admin/</span></a></span></span></p>
<p><span style="font-size: 14px;">
<p><span style="font-family: 宋体;"><span style="line-height: 21px;">&nbsp;</span></span></p>
</span></p>
<p>&nbsp;</p>
<p><span style="font-size: 14px;">
<p><span style="font-family: 宋体;"><span style="line-height: 21px;">服务器开始Socket扩展 welive需要用到它</span></span></p>
</span></p>
<p><span style="font-size: 14px;">再增加lhc_web（livehelperchat）聊天系统 服务器要打开php_curl扩展 &nbsp;客户端下载地址：http://livehelperchat.com/var/lhc_dc_qt5.zip</span></p>
<p><span style="font-size: 14px;">登陆页：</span><a href="http://cn.yetpress.com/lhc_web/index.php/site_admin/user/login"><span style="font-size: 14px;">http://cn.yetpress.com/lhc_web/index.php/site_admin/user/login</span></a><span style="font-size: 14px;">&nbsp;</span></p>
<p><span style="font-size: 14px;"><span style="font-family: 宋体; line-height: 21px;">-------------------------------------------------------------</span></span></p>
<p><span style="font-family:宋体"><span style="font-size: 14px; line-height: 21px;"><a href="http://www.ezencart.com/pages/1091.html" _src="http://www.ezencart.com/pages/1091.html"><span style="font-size: 14px;">http://www.ezencart.com/pages/1091.html</span></a></span></span><span style="font-size: 14px;"><span style="font-family: 宋体;"><span style="line-height: 21px;">&nbsp; &nbsp;&nbsp;另一款界面好用的php在线客服</span></span>&nbsp;</span></p>
<p><a href="http://www.downxia.com/downinfo/26181.html" _src="http://www.downxia.com/downinfo/26181.html"><span style="font-size: 14px;">http://www.downxia.com/downinfo/26181.html</span></a><span style="font-size: 14px;">&nbsp;国产免费客服系统</span></p>
<p><span style="font-size: 14px;">&nbsp;</span></p>
<p><span style="font-size: 14px;">&nbsp;</span></p>
...
<div class="article_comment">
    <form action="http://cn.yetpress.com/e/pl/doaction.php" method="post" name="saypl" id="saypl" onsubmit="return CheckPl(document.saypl)">
        <div class="comment_title"><span>发表评论</span>
            <a href=javascript:void(0) class="comment_count" target="_blank">​共有<span>​<script type="text/javascript" src="http://cn.yetpress.com/e/public/ViewClick/?classid=34&id=6&down=2"></script></span>​条评论</a>​
        </div>
        <script>
        $(function(){
            var url="http://cn.yetpress.com/e/pl/?classid=34&id=6";
            ...
            <div class="comment_userinfo">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="hidden" name="ecmsfrom" value="http://cn.yetpress.com/sec/2015-02-28/6.php"><!-- 提交后返回地址 9为提交页面地址 -->
...
<div class="clear"></div>
    ...
    <ul>
      ...
      <div class="meta">
        <div class="info">
            <p>
                Server time: <strong><span id='serverTime'>2016-06-20 18:08:15</span></strong>&nbsp;&nbsp;&nbsp;Users currently online: <strong><span id='usersOnline'>667</span></strong>&nbsp;&nbsp;&nbsp;Accounts registered: <strong><span id='accountsRegistered'>61744</span></strong><br />
            </p>
