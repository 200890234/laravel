...
<html lang="en">
<head>
    <title>yetpress - 暂存 - 网站建设 资源分享 网络赚钱 英语学习 创意恶搞 绝密资料</title>
    <meta charset="UTF-8">
                ...
                <div class="list_main">
                    ...
                    <div class="list_middle">
                        ...
                        <div class="article_content">
                            <div class="content_title"><h4>暂存</h4></div>
                            <div class="article_info">
                                发布时间：2015-12-20 &nbsp;&nbsp;
                                发布者：mervyn &nbsp;&nbsp;
                                <!-- 字体大小：12px 14px&nbsp; -->
                                <a href="http://cn.yetpress.com/e/tool/feedback/?bid=2&info_id=129&info_url=http://cn.yetpress.com/sec/2015-12-20/129.php">[ 信息报错 ]</a>
                                <a href="">[ 意见建议 ]</a>
                                <a href="http://cn.yetpress.com/e/tool/feedback/?bid=3&info_id=129&info_url=http://cn.yetpress.com/sec/2015-12-20/129.php">[ 请求删帖 ]</a>
                            ...
                            <div class="content_body">
                                <p>&nbsp;从属于网站开发组。主要负责网站方面的开发和技术支持。入职半年多以</p>
<div>&nbsp;</div>
<div>来有效利用所掌握的技术应用到实际工作中。能及时响应并解决工作中遇</div>
<div>&nbsp;</div>
<div>到的问题，与部门相关人员配合良好，较合理地利用资源共同完成需求，</div>
<div>&nbsp;</div>
<div>解决问题。遇紧急任务能按需安排时间，保障工作进度。不定时总结和整</div>
<div>&nbsp;</div>
<div>理遇到的问题和接触到的新知识。主要工作业绩如下：</div>
<div>&nbsp;</div>
<div>为留学和语培网站各类专题提供后台支持；</div>
<div>响应并完成北京外语学校和齐进法语的修改任务；</div>
<div>完成留学站点PC端和移动端计划内的所有改版任务；</div>
<div>完成语培站点PC端和移动端计划内的所有改版任务；</div>
<div>协助完成站点推广功能相关代码的部署；</div>
<div>&nbsp;</div>
<div>&nbsp;</div>
<div>&nbsp;</div>
<div>&nbsp;</div>
<div>&nbsp;</div>
<div>准分子电话：<span style="font-family: Tahoma; font-size: 16px;">28069863</span></div>                            </div>
                            <div class="article_pager"></div>
                            <div class="article_prenext">
                                                                    <p>上篇：<a href="http://cn.yetpress.com/sec/2015-04-09/81.php" title="cps平台相关">cps平台相关</a></p>
                                                                                            </div>
                            <div class="clear"></div>
<script>
...
<div class="article_comment">
    <form action="http://cn.yetpress.com/e/pl/doaction.php" method="post" name="saypl" id="saypl" onsubmit="return CheckPl(document.saypl)">
        <div class="comment_title"><span>发表评论</span>
            <a href=javascript:void(0) class="comment_count" target="_blank">​共有<span>​<script type="text/javascript" src="http://cn.yetpress.com/e/public/ViewClick/?classid=34&id=129&down=2"></script></span>​条评论</a>​
        </div>
        <script>
        $(function(){
            var url="http://cn.yetpress.com/e/pl/?classid=34&id=129";
            ...
            <div class="comment_userinfo">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="hidden" name="ecmsfrom" value="http://cn.yetpress.com/sec/2015-12-20/129.php"><!-- 提交后返回地址 9为提交页面地址 -->
