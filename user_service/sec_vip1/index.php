...
<html lang="en">
<head>
    <title>yetpress - 私密vip会员区 - 网站建设 资源分享 网络赚钱 英语学习 创意恶搞 绝密资料</title>
    <meta charset="UTF-8">
...
<body class="feature home">
                ...
                <div class="list_main">
                    <div class="list_left">
                        ...
                        <ul class="left_navul">
                                                        ...
                                                        <li><a href="http://cn.yetpress.com/user_service/sec_vip1/" class='left_navon'>私密vip会员区</a></li>
                    ...
                    <div class="list_middle">
                        <div class="intro_title">
                            <div class="crumb">
                                位置：<a href="http://cn.yetpress.com/">首页</a>&nbsp;>&nbsp;<a href="http://cn.yetpress.com/user_service/">会员服务区</a>&nbsp;>&nbsp;<a href="http://cn.yetpress.com/user_service/sec_vip1/">私密vip会员区</a>
                            </div>
        ...
        $(function(){
            $('#go_list_search').click(function(){
                ...
                if(!key){
                    ...
                    //$('#list_search').submit();
                    //直接用结合项跳转页面
                    window.location.href="http://cn.yetpress.com/e/action/ListInfo.php?classid=43&ph=1&title="+key;
                }
            })
        })
    </script>
                            ...
                            <div class="listtags">
                                   <a href="http://cn.yetpress.com/e/action/ListInfo.php?classid=43">全部分类</a>
                                                            </div>
                        </div>
                        <div class="clear"></div>
                        <ul class="list_ul">
    ...
    <ul>
      ...
      <div class="meta">
        <div class="info">
            <p>
                Server time: <strong><span id='serverTime'>2016-07-08 15:34:09</span></strong>&nbsp;&nbsp;&nbsp;Users currently online: <strong><span id='usersOnline'>667</span></strong>&nbsp;&nbsp;&nbsp;Accounts registered: <strong><span id='accountsRegistered'>61744</span></strong><br />
            </p>
