...
<html lang="en">
<head>
    <title>yetpress - 普通会员区 - 网站建设 资源分享 网络赚钱 英语学习 创意恶搞 绝密资料</title>
    <meta charset="UTF-8">
            ...
            <!-- BEGIN CONTENT AREA -->
                <div class="list_main">
                    <div class="list_left">
                        ...
                        <ul class="left_navul">
                                                        <li><a href="http://cn.yetpress.com/user_service/general/" class='left_navon'>普通会员区</a></li>
                                                        ...
                                                        <li><a href="http://cn.yetpress.com/user_service/vip3/" >个性化vip会员区</a></li>
                    ...
                    <div class="list_middle">
                        <div class="intro_title">
                            <div class="crumb">
                                位置：<a href="http://cn.yetpress.com/">首页</a>&nbsp;>&nbsp;<a href="http://cn.yetpress.com/user_service/">会员服务区</a>&nbsp;>&nbsp;<a href="http://cn.yetpress.com/user_service/general/">普通会员区</a>
                            </div>
        ...
        $(function(){
            $('#go_list_search').click(function(){
                ...
                if(!key){
                    ...
                    //$('#list_search').submit();
                    //直接用结合项跳转页面
                    window.location.href="http://cn.yetpress.com/e/action/ListInfo.php?classid=38&ph=1&title="+key;
                }
            })
        })
    </script>
                            ...
                            <div class="listtags">
                                   <a href="http://cn.yetpress.com/e/action/ListInfo.php?classid=38">全部分类</a>
                                                            </div>
                        </div>
                        <div class="clear"></div>
                        <ul class="list_ul">
