...
<body bgcolor="#1ABC9C" text="#000000" link="#C28400" vlink="#C28400" alink="#C28400" style="margin:0px;">

<table width="100%" style="height:100%;" cellspacing="0" cellpadding="0" border="0">
<tr>
<td valign="top">

	<table width="100%" style="height:250px;" cellspacing="0" cellpadding="0" border="0">
	<tr>
    <td></td>
    ...
    <td valign="top">
    	...
    	<td colspan="2" width="100%" height="100%" valign="top" id="chatwndtd">
		    ...
		    <td width="100%" height="100%" bgcolor="#FFFFFF" valign="top">
				<iframe id="chatwnd" width="100%" height="250px" src="${if:neediframesrc}${mibewroot}/images/blank.html${endif:neediframesrc}" frameborder="0" style="overflow:auto;background:#8FDABA;">
