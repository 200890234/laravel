...
class CreateModtbfieldsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('modtbfields', function (Blueprint $table) {
            $table->increments('f_id');
            $table->string('f_name',60);
            $table->string('f_alias_name',60)->comment('模型标识别名');
            $table->integer('f_tb_id')->comment('所属数据表id');
            $table->string('f_tb_name',30)->comment('所属数据表名');
