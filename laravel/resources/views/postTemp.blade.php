...
<p>位置： 数据字典文章管理</p>
				...
				<div class="main_body">
					...
					<div class="clear"></div>
						<form action="{{ url('admin/doPostTemp') }}" method="post">
									...
									<table cellpadding="1" cellspacing="1" class="post_tb">
										<tbody>
											...
											<tr>
												...
												<td>
													<input type="text" class="input600" name="title" value="{{ old('title') }}">
												</td>
											</tr>
											<tr>
												<td class="post_r">内容：</td>
												<td><textarea name="content" id="content">{{ old('content') }}</textarea></td>
											</tr>
